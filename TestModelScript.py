...
#Parameters Path
Parameters_path='C:/Users/kgj1234/Desktop/Machine-Learning-for-Position-Decoding-from-Hippocampal-Data-master/SpikeNN/Parameters2018-06-26spike_results.p'
...
test_indices=np.arange(0,int(.2*neural_activity.shape[0]))
...
r2,rmse,pred,actual,gradients=TestModelWrapper.TestModelWrapper(neural_activity,xpos,ypos,scale=1,length=10,offset=4,neurons=None,param_value=None,model_type='NN',
						Left=False,plot_res=True,cutoff=0,tracklength=None,method=None,result_name='testresult',filtering=4,model_name=model_path,save_res=True,
